...
category_list = {
    ...
    ("anli", "dev_r1"): "natural language inference",
    ("anli", "dev_r2"): "natural language inference",
    ("anli", "dev_r3"): "natural language inference",
    ("super_glue", "wsc.fixed"): "coreference solution",
    ("winogrande", "winogrande_xl"): "coreference solution",
    ("story_cloze", "2016"): "sentence completion",
